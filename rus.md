...
приложения и хотиет измерить, сколько элементов в итоге меняются из-за DOM-
операции.
...
указываете единственный параметр — функцию-колбэк.
...
_<span id="MutationObserver">Листинг 3</span>: Создаем наблюдатель за изменениями._
...
_<span id="usingobservefunction">Листинг 4</span>: Решаем, какой элемент и тип изменения мы будем отслеживать_
...
_<span id="watchchildnodes">Листинг 5</span>: Наблюдаем за добавлением и удалением дочерних элементов в документе._
...
_<span id="filteringattributes">Листинг 7</span>: Фильтруем атрибуты, за которыми мы наблюдаем._
